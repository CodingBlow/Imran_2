...
const SERVICE_DATA: Record<string, ServiceData> = {
  ...
  "5": {
    ...
    acTypes: ["Window AC (R22)", "Split AC (R22)", "Split AC (R32/410)", "Cassette AC"],
    approximateTime: "1–2 Hours",
    procedure: [
  ...
  "6": {
    ...
    procedure: [
      "VRV/VRF system health diagnostics",
      "All indoor unit filter & coil cleaning",
      "Refrigerant level check across all units",
      "Drain & condensate pump inspection",
      "Controller & BMS integration check",
    ],
    inclusions: [
...
const BookingConfirmation = () => {
  ...
  const sendToTelegram = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({ title: "Booking Confirmed!", description: "We'll call you shortly." });
    ...
    <div className="min-h-screen bg-white font-sans antialiased text-gray-900 mt-10 md:mt-20">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <p className="text-xs text-gray-400 mb-6">
          Home / Services / <span className="text-gray-700 font-medium">{data.name}</span>
        </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-baseline gap-3">
              ...
              <span className="text-2xl font-black text-[#0416c7]">
                {currentTier.price === 0 ? "Get Quote" : `₹${currentTier.price.toLocaleString()}`}
              </span>
              <span className="text-xs text-gray-400">per unit (labour only)</span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm font-semibold text-gray-700 w-24 shrink-0">AC Type</span>
            ...
            {/* Quantity */}
            <div className="flex items-center gap-4">
              <span className="text-sm font-semibold text-gray-700 w-24 shrink-0">Quantity</span>
            ...
            {currentTier.price > 0 && quantity > 1 && (
              <p className="text-sm text-gray-500">
                Total: <span className="font-bold text-gray-900">₹{totalPrice.toLocaleString()}</span>
              </p>
            )}
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {["Satisfaction Guaranteed", "No Hassle Refunds", "Secure Payments"].map((t) => (
        ...
        <div className="border-t border-gray-100 pt-8">
          <h2 className="text-xl font-extrabold text-gray-900 mb-6">Description</h2>
            ...
            <div className="flex flex-col gap-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-bold text-gray-700">Approximate Time</span>
                </div>
                <p className="text-sm text-gray-500 pl-6">{data.approximateTime}</p>
              </div>
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Wrench className="w-4 h-4 text-[#0416c7]" />
                  <span className="text-sm font-bold text-gray-700">Procedure</span>
                </div>
            ...
            <div className="flex flex-col gap-6">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-sm font-bold text-gray-700">Inclusions</span>
                </div>
              ...
              <div>
                <span className="text-sm font-bold text-gray-700 block mb-3">Exclusions</span>
                <ul className="pl-2 flex flex-col gap-2">
        ...
        <DialogContent className="sm:max-w-md rounded-2xl">
          ...
          <div className="bg-gray-50 rounded-xl p-3 text-sm flex flex-col gap-1 border border-gray-100">
            <div className="flex justify-between">
              ...
              <span className="font-semibold text-gray-800">{selectedType}</span>
            </div>
            <div className="flex justify-between">
            ...
            {currentTier.price > 0 && (
              <div className="flex justify-between border-t border-gray-200 pt-1 mt-1">
                ...
                <span className="font-black text-[#0416c7]">₹{totalPrice.toLocaleString()}</span>
              </div>
            )}
          </div>
