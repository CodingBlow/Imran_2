      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <Card className="p-8 shadow-lg">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              By accessing and using Smart Eager's services, you agree to be
              bound by these Terms and Conditions. Please read them carefully
              before proceeding with any rental or service.
            </p>
          </div>
        </Card>
        ...
        <Card className="p-8 shadow-lg">
          ...
          <div className="space-y-4 text-gray-700">
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Security deposit is refundable upon successful return of
                equipment
              </li>
        ...
        <Card className="p-8 shadow-lg">
          ...
          <div className="space-y-4 text-gray-700">
            <p>Smart Eager is not liable for:</p>
            <ul className="list-disc list-inside space-y-2">
